function [rps_P, thetaps_P, Bounds, chsd] = planeSearch_LeaderFollower(t, Herder, Target)

global P Q xstar

ChasedIndex = (Q+1)*ones(Q,P);

Herder_angle(1) = wrapTo2Pi(Herder(1).theta(1,t));

LB(1) = Herder_angle(1) - pi / P ;
UB(1) = LB(1) + 2 * pi / P ;
